package com.studi.timesyncwifi.layout;
...
public class AutoFitText extends TextView {
    ...
    private final int MAX_TEXT_SIZE = 2000;
    ...
    private boolean minimizeHeight = false;
    ...
    private void refitText(String text, int targetFieldWidth, int targetFieldHeight) {
        ...
        mTestView.setLayoutParams(new ViewGroup.LayoutParams(targetFieldWidth, targetFieldHeight));
